...
#define  DEVICE_NAME "simple_driver_atividade1" ///< The device will appear at /dev/simple_driver using this value
#define  CLASS_NAME  "simple_atividade1_class"        ///< The device class -- this is a character device driver
